...
- [sydr-fuzz](sydr-fuzz) - подробное описание опций и применения инструмента гибридного фаззинга Sydr-Fuzz.
- [install](install) - зависимости и установка релиза Sydr-Fuzz.
- [config](config) - полная спецификация конфигурационного файла для Sydr-Fuzz.
- [sydr](sydr) - документация Sydr - инструмента динамической символьной интерпретации, входящего в состав Sydr-Fuzz.
- [libafl-difuzz](libafl) - документация LibAFL-DiFuzz - направленного фаззера, входящего в состав Sydr-Fuzz.
- [misc](misc) - инструкции по созданию фаззинг целей и подготовки докера для фаззинга.
